    ...
    async def build_query(self):
        ...
        for model in model_list:
            ...
            if model_data.get("create_time"):
                model_data["create_time"] = convert_to_standard_format(model_data["create_time"])
            if model_data.get("update_time"):
                model_data["update_time"] = convert_to_standard_format(model_data["update_time"])
            if model_data.get("go_live_time"):
                model_data["go_live_time"] = convert_to_standard_format(model_data["go_live_time"])
